...
export default function EditTools() {
  ...
  const startCrop = () => {
    ...
    setIsCropping(true);
    toast.info("Crop feature - Use rotation and then download to crop manually. Advanced crop tool coming soon!");
  };
  ...
  const enableDrawing = () => {
    ...
    img.onload = () => {
      ...
      toast.success("Drawing enabled! Click and drag on the canvas to draw");
    };
    img.onerror = () => {
      toast.error("Failed to load image for drawing");
    };
    img.src = selectedImage;
  };
